...
public:
    ...
    struct Edge {
        ...
        Edge(Node* from, Node* to, bool from_side, bool to_side);
    ...
    struct Node {
        ...
        ValiantBase::Edge* get_in_edge(bool side);
        ValiantBase::Edge* get_out_edge(bool side);
        Node* get_parent(bool side);
        Node* get_child(bool side);
        void remove_in_edge(bool side);
        void remove_out_edge(bool side);
...
public:
    ...
    void add_edge(Node* from, Node* to, bool);
    void add_edge(Node* from, Node* to, bool from_side, bool to_side);
